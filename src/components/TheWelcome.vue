        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                ...
                <p class="mt-8 text-pretty text-lg font-medium text-gray-300 sm:text-xl/8">
                    A platform that has unlimited ways of work, providing good and wonderful products that will increase
                    your
                    productivity.<br>
                    We provide software solutions to any kind of your problem.<br>
                    If you're in need of a website, web app, desktop app or mobile app then you're in a right place.<br>
                    <strong>
                        Let us handle your software problem, with our software solutions, you handle you
                        business.
                    </strong>
                </p>
            </div>
            <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
                <dl class="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="flex flex-col-reverse gap-1">
                        ...
                        <dd class="text-4xl font-semibold tracking-tight text-white">70</dd>
                    </div>
                    <div class="flex flex-col-reverse gap-1">
